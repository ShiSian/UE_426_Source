...
struct TClassCompiledInDefer : public FFieldCompiledInInfo
{
	...
	{
		/*调用了UClassCompiledInDefer来收集类名字，类大小，CRC信息，并把类信息添加到静态数组HotReloadClasses中*/
	...
	virtual UClass* Register() const override
	{
		...
		//GetPrivateStaticClass(TPackage)的函数是实现是在IMPLEMENT_CLASS宏里。其内部会真正调用到GetPrivateStaticClassBody。
